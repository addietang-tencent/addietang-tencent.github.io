          ...
          <div className="px-4 pt-4 pb-3 space-y-3">
            ...
            {draftScope === "groups" && (
              <div className="space-y-2.5">
                {/* 输入框：已选标签 + 搜索输入 */}
                <div
                  className="flex flex-wrap items-center gap-1 px-2.5 py-1.5 min-h-[36px] max-h-[80px] overflow-y-auto border border-gray-200 rounded-[4px] bg-white focus-within:border-[#1447E6] transition-colors cursor-text"
