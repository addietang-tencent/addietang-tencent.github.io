  ...
  ({ asChild = false, className, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          "flex min-w-0 items-center gap-2.5 rounded-lg text-left outline-none transition-colors hover:bg-gray-50 focus-visible:ring-2 focus-visible:ring-[var(--brand-blue)]",
          className
        )}
        {...props}
      />
