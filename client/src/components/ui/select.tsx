  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "disabled:cursor-not-allowed disabled:bg-[#FAFAFA] disabled:border-gray-200 disabled:text-gray-400",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "relative z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-[4px] shadow-[0px_0px_2px_0px_rgba(0,0,0,0.1),0px_4px_16px_0px_rgba(0,0,0,0.12)]",
          position === "popper" &&
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "hover:bg-[#FAFAFA]",
        "focus:bg-[#FAFAFA]",
        "data-[state=checked]:text-blue-500 data-[state=checked]:font-medium",
