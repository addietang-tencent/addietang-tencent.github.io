    ...
    <TableVariantContext.Provider value={variant}>
      ...
      >
        ...
        {tableMinWidth && scrollState.scrollLeft && fixedShadowMetrics.leftX !== null && (
          <div
            aria-hidden
            className="pointer-events-none absolute top-0 bottom-0 z-30 w-[6px] bg-[linear-gradient(to_right,rgba(0,0,0,0.04),transparent)]"
        ...
        {tableMinWidth && scrollState.scrollRight && fixedShadowMetrics.rightX !== null && (
          <div
            aria-hidden
            className="pointer-events-none absolute top-0 bottom-0 z-30 w-[6px] bg-[linear-gradient(to_left,rgba(0,0,0,0.04),transparent)]"
...
function TableCell({ className, fixed, fixedShadow = true, ...props }: TableCellProps) {
  ...
  return (
    <td
      ...
      data-fixed={fixed}
      className={cn(
        "text-left align-middle whitespace-nowrap font-sans font-normal leading-[1.5] text-gray-950 text-xs transition-colors group-hover:bg-[#FAFBFD] [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
