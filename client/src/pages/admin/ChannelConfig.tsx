...
function WechatIcon() {
  return (
    <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "#07C160" }}>
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="white">
        <path d="M8.69 11.52c-.46 0-.84-.38-.84-.84s.38-.84.84-.84.84.38.84.84-.38.84-.84.84zm4.62 0c-.46 0-.84-.38-.84-.84s.38-.84.84-.84.84.38.84.84-.38.84-.84.84zM12 2C6.48 2 2 6.03 2 11c0 2.71 1.27 5.14 3.29 6.83L4 21l3.5-1.75C8.89 19.71 10.41 20 12 20c5.52 0 10-4.03 10-9S17.52 2 12 2zm5.5 13.5c-.28.56-1.07 1-1.75 1.12-.46.08-1.06.15-3.08-.66-2.59-1.04-4.26-3.66-4.39-3.83-.13-.17-1.08-1.44-1.08-2.74 0-1.3.68-1.94 1.08-2.34.34-.34.72-.43.96-.43.24 0 .48 0 .69.01.22.01.52-.08.81.62.3.72 1.02 2.49 1.11 2.67.09.18.15.39.03.63-.12.24-.18.39-.36.6-.18.21-.38.47-.54.63-.18.18-.37.38-.16.74.21.36.94 1.55 2.02 2.51 1.39 1.24 2.56 1.62 2.92 1.8.36.18.57.15.78-.09.21-.24.9-1.05 1.14-1.41.24-.36.48-.3.81-.18.33.12 2.1 .99 2.46 1.17.36.18.6.27.69.42.09.15.09.87-.19 1.43z"/>
      </svg>
    </div>
  );
}
