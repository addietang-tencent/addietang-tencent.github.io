              ...
              {displayTypes.map((t) => {
                ...
                return (
                  <button
                    ...
                    className={`group flex items-center justify-between gap-2 px-3 py-2 rounded-lg text-left text-sm transition-colors ${
                      isActive
                  ...
                  >
                    <span className="flex items-center gap-1.5 min-w-0">
                      {isDefault ? (
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full shrink-0" style={{ background: "linear-gradient(135deg, #007AFF, #5856D6)" }}>
          ...
          {displayTypes.map((agentTypeObj) => {
            ...
            return (
              <div
                ...
                className={`rounded-2xl border overflow-hidden transition-all scroll-mt-6 ${isDefault ? "border-blue-300 ring-1 ring-blue-200" : "border-gray-100"}`}
        ...
        >
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={!canImport}
              style={canImport ? { background: "linear-gradient(135deg, #007AFF, #5856D6)" } : {}}
            >
              导入
            </Button>
          </DialogFooter>
