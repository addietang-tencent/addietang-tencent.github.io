 ...
 * - 品牌渐变：linear-gradient(90deg, #020617 70%, #1447E6 100%)
  ...
  return (
    <div>
      <div className="grid grid-cols-[1fr_1.5fr] gap-5">
        {/* Free 版卡片 */}
        <div 
          className="bg-white rounded-[4px] border border-gray-200 p-5 hover:shadow-md transition-all duration-200 flex flex-col"
        ...
        {/* Pro 版卡片 */}
        <div 
          className="bg-white rounded-[4px] border border-blue-200 p-5 hover:shadow-md transition-all duration-200 flex flex-col"
          style={{ boxShadow: '0px 1px 4px rgba(0,0,0,0.05), 0px 0px 2px rgba(0,0,0,0.1)' }}
        >
          {/* 头部 */}
          <div className="flex items-center gap-3 mb-5">
            ...
            {/* 已开通状态标签 */}
            {isProActive && (
              <div className="inline-flex items-center gap-1 px-2 py-1 rounded-[4px] bg-green-100 text-green-700 text-xs font-medium">
          ...
          <div className="grid grid-cols-2 gap-2.5 mt-4">
            <div className="flex items-center gap-2 px-3 py-2.5 rounded-[4px] bg-gray-50 border border-gray-100">
