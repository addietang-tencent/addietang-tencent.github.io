  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-3">
        <h3 className="text-xs font-semibold text-[#737373]">Pro 版独有能力</h3>
            ...
            >
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-1.5 mb-0.5">
                  <h4 className="text-xs font-semibold text-[#0A0A0A]">{f.title}</h4>
                  {f.tag && (
                ...
                <p className="text-[11px] text-[#A3A3A3] leading-relaxed line-clamp-2">{f.desc}</p>
              </div>
            </div>
          );
        })}
