...
export default function SyncAssetBtn({ btnType = undefined, style = {}, refreshTable, refreshFromLock = undefined, rencentScanTime }:any) {
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        {btnType === 'link' && syncLoading ? (
          ...
          <Button
            variant={btnType === 'link' ? 'link' : 'default'}
            style={style || {}}
