...
const BindErrModal = (props: any) => {
  ...
  return (
    ...
    >
      <DialogContent className="max-w-4xl" style={{ maxWidth: 900 }}>
        <DialogHeader>
          <DialogTitle>
            <span className="auth-item-modal-header">以下 </span>
            <span className="auth-item-modal-header" style={{ color: '#d0021b', margin: '0 5px' }}>
              {bindErrTotal}
            </span>
            <span className="auth-item-modal-header"> 台OpenClaw绑定失败</span>
          </DialogTitle>
        </DialogHeader>
        <div>
          <div className="mb-4">
          ...
          <div className="mt-4" style={{ marginLeft: -20 }}>
            <Pagination
              page={bindErrQuery.Offset / bindErrQuery.Limit + 1}
              total={bindErrTotal}
              pageSize={10}
