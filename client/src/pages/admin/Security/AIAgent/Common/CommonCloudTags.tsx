      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Badge variant="outline" className="cursor-pointer gap-1 px-1 py-0">
            ...
            <span className="text-blue-600">({transformTags(item)?.length + (item?.CloudTags ?? [])?.length})</span>
          </Badge>
        </TooltipTrigger>
        <TooltipContent side="top" className="max-h-[500px] overflow-y-auto shadow-lg">
