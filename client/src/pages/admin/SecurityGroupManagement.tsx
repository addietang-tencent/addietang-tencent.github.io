        ...
        <div className="mb-10">
          ...
          <div className="flex items-start gap-2.5 bg-blue-50 border border-blue-100 rounded-xl px-4 py-3 mb-5">
            ...
            <ul className="text-xs text-blue-700 leading-relaxed space-y-1">
              ...
              <li className="flex gap-1.5">
                <span className="shrink-0">•</span>
                <span><strong>指定私有网络和子网</strong> — 系统会为所有用户的 OpenClaw 实例分配到指定的私有网络，同一个私有网络下的 OpenClaw 实例内网可互通，建议同时将安全组策略设置为内网不互通，以实现OpenClaw实例间的隔离。系统按填写了子网的可用区随机部署 OpenClaw 实例，不填的可用区不部署。</span>
              </li>
            </ul>
          </div>
