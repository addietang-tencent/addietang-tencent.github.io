      ...
      <div className="px-5 pt-5 pb-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h3 className="text-[14px] font-semibold text-[#020617]">SkillHub 地址</h3>
            <p className="text-[12px] text-[#737373] leading-relaxed mt-1">
          ...
          {editing ? (
            <div className="flex flex-col gap-2">
              <Input
                ...
                className={`text-sm ${errorMessage ? "border-red-500" : ""}`}
                autoFocus
                onKeyDown={(e) => {
            ...
            <div className="text-[13px] text-[#020617] leading-5">
              {skillhubUrl || <span className="text-[#737373]">未配置</span>}
            </div>
          )}
        </div>
      </div>
        ...
        <div className="flex items-center gap-2 border-b border-[#dbe6ff]">
          {TABS.map((tab) => (
            <button
              ...
              className={`relative px-4 py-3 text-[14px] font-medium transition-colors whitespace-nowrap inline-flex items-center gap-1.5 ${
                activeTab === tab.id
