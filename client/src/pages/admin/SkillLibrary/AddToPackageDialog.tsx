        ...
        {!result ? (
                ...
                {packages.length > 0 ? (
                  packages.map(pkg => (
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-2.5 rounded-[4px] border text-left transition-colors ${
          ...
          <>
            ...
            <div className="space-y-3 my-2">
              ...
              {result.isActive ? (
                <div className="flex items-start gap-2 bg-amber-50 border border-amber-200 rounded-[4px] p-3">
                ...
                <div className="flex items-start gap-2 bg-green-50 border border-green-200 rounded-[4px] p-3">
