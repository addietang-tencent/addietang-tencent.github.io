    ...
    <div>
      {isSection ? (
        <div className="px-2 pt-3 pb-1">
          <span className="text-xs font-medium text-[var(--text-weak)] uppercase tracking-wide">{node.name}</span>
        </div>
      ) : (
        <div
          className={`flex items-center gap-1 py-1.5 px-2 rounded-[4px] cursor-pointer transition-colors ${
              ...
              <span className="flex items-center gap-0.5 truncate">
                {selectedNode.path.split("/").map((seg, idx, arr) => (
                  <span key={idx} className="flex items-center gap-0.5 shrink-0">
                    {idx > 0 && <span className="text-[var(--text-weak)] mx-0.5">›</span>}
                    <span className={idx === arr.length - 1 ? "text-[#355EF1] font-medium" : "text-[var(--text-muted)]"}>{seg}</span>
                  </span>
                ))}
              </span>
            ) : selectedNode ? (
  ...
  return (
      <div className="page-enter">
        ...
        <div className="grid grid-cols-5 gap-5 mb-6">
          ...
          <SurfaceCard className="p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium text-[var(--text-title)]">总请求数</span>
            </div>
          ...
          <SurfaceCard className="p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium text-[var(--text-title)]">输入 Tokens</span>
            </div>
          ...
          <SurfaceCard className="p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium text-[var(--text-title)]">输出 Tokens</span>
            </div>
          ...
          <SurfaceCard className="p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium text-[var(--text-title)]">总 Tokens</span>
            </div>
        ...
        <Tabs defaultValue="instance">
          <TabsList className="flex items-center gap-2 border-b border-[#dbe6ff] mb-3 bg-transparent h-auto p-0 rounded-none">
              <TabsTrigger value="instance" className="relative px-4 py-3 text-[14px] font-medium transition-colors whitespace-nowrap text-[var(--text-muted)] hover:text-[var(--text-title)] data-[state=active]:text-[var(--text-title)] data-[state=active]:border-b-2 data-[state=active]:border-[#0A0A0A] data-[state=active]:-mb-px bg-transparent shadow-none rounded-none h-auto border-0 data-[state=active]:bg-transparent data-[state=active]:shadow-none">按实例</TabsTrigger>
              <TabsTrigger value="member" className="relative px-4 py-3 text-[14px] font-medium transition-colors whitespace-nowrap text-[var(--text-muted)] hover:text-[var(--text-title)] data-[state=active]:text-[var(--text-title)] data-[state=active]:border-b-2 data-[state=active]:border-[#0A0A0A] data-[state=active]:-mb-px bg-transparent shadow-none rounded-none h-auto border-0 data-[state=active]:bg-transparent data-[state=active]:shadow-none">按用户</TabsTrigger>
              <TabsTrigger value="model" className="relative px-4 py-3 text-[14px] font-medium transition-colors whitespace-nowrap text-[var(--text-muted)] hover:text-[var(--text-title)] data-[state=active]:text-[var(--text-title)] data-[state=active]:border-b-2 data-[state=active]:border-[#0A0A0A] data-[state=active]:-mb-px bg-transparent shadow-none rounded-none h-auto border-0 data-[state=active]:bg-transparent data-[state=active]:shadow-none">按模型</TabsTrigger>
              {hasOneid && <TabsTrigger value="department" className="relative px-4 py-3 text-[14px] font-medium transition-colors whitespace-nowrap text-[var(--text-muted)] hover:text-[var(--text-title)] data-[state=active]:text-[var(--text-title)] data-[state=active]:border-b-2 data-[state=active]:border-[#0A0A0A] data-[state=active]:-mb-px bg-transparent shadow-none rounded-none h-auto border-0 data-[state=active]:bg-transparent data-[state=active]:shadow-none">按部门</TabsTrigger>}
              <TabsTrigger value="group" className="relative px-4 py-3 text-[14px] font-medium transition-colors whitespace-nowrap text-[var(--text-muted)] hover:text-[var(--text-title)] data-[state=active]:text-[var(--text-title)] data-[state=active]:border-b-2 data-[state=active]:border-[#0A0A0A] data-[state=active]:-mb-px bg-transparent shadow-none rounded-none h-auto border-0 data-[state=active]:bg-transparent data-[state=active]:shadow-none">按分组<span className="absolute top-1 right-0.5 w-1.5 h-1.5 bg-red-500 rounded-full" /></TabsTrigger>
              <TabsTrigger value="session" className="relative px-4 py-3 text-[14px] font-medium transition-colors whitespace-nowrap text-[var(--text-muted)] hover:text-[var(--text-title)] data-[state=active]:text-[var(--text-title)] data-[state=active]:border-b-2 data-[state=active]:border-[#0A0A0A] data-[state=active]:-mb-px bg-transparent shadow-none rounded-none h-auto border-0 data-[state=active]:bg-transparent data-[state=active]:shadow-none">按会话</TabsTrigger>
          </TabsList>
              ...
              <div className="flex items-center justify-between mb-4 gap-4">
                ...
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  <AgentCombobox
                    ...
                    className="w-[240px]"
                  />
                  <p className="text-xs text-[var(--text-weak)] truncate">全部会话已按 tokens 排序，点击可查看会话详情</p>
                </div>
      ...
      <AlertDialog open={showCloseClsConfirm} onOpenChange={setShowCloseClsConfirm}>
        <AlertDialogContent className="sm:max-w-[560px]">
          ...
          <AlertDialogHeader>
            <AlertDialogTitle className="text-[var(--text-title)]">确定要关闭 CLS 日志服务吗？</AlertDialogTitle>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 space-y-2">
                      <Label
                        ...
                        className="text-sm font-medium text-[var(--text-title)] cursor-pointer"
                        onClick={(e) => e.stopPropagation()}
                      >
                        同时删除关联的日志主题资源
                      </Label>
