        ...
        <div className="grid grid-cols-5 gap-5 mb-6">
          ...
          <SurfaceCard className="p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm text-[var(--text-title)]">总请求数</span>
            </div>
          ...
          <SurfaceCard className="p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm text-[var(--text-title)]">输入 Tokens</span>
            </div>
          ...
          <SurfaceCard className="p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm text-[var(--text-title)]">输出 Tokens</span>
            </div>
          ...
          <SurfaceCard className="p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm text-[var(--text-title)]">总 Tokens</span>
            </div>
          ...
          <SurfaceCard className="p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm text-[var(--text-title)] flex items-center gap-1">
        ...
        <Segment defaultValue="instance">
          ...
          <SegmentContent value="instance">
            <div className="flex items-center justify-between mb-3">
              <p className="text-xs text-[var(--text-weak)]">汇总所选时间范围内每台实例的 Token 消耗，按总 Tokens 降序排序</p>
              <UITooltip>
                <UITooltipTrigger asChild>
                  <Button
                    variant="claw-outline"
          ...
          <SegmentContent value="member">
            <div className="flex items-center justify-between mb-3">
              <p className="text-xs text-[var(--text-weak)]">汇总所选时间范围内每个用户使用所有模型的消耗，按总 Tokens 降序排序</p>
              <UITooltip>
                <UITooltipTrigger asChild>
                  <Button
                    variant="claw-outline"
          ...
          <SegmentContent value="model">
            <div className="flex items-center justify-between mb-3">
              <p className="text-xs text-[var(--text-weak)]">汇总所选时间范围内每个模型被所有企业用户使用的消耗，按总 Tokens 降序排序</p>
              <UITooltip>
                <UITooltipTrigger asChild>
                  <Button
                    variant="claw-outline"
          ...
          {hasOneid && (
            <SegmentContent value="department">
              <div className="flex items-center justify-between mb-3">
                <p className="text-xs text-[var(--text-weak)]">汇总所选时间范围内各部门的消耗，按总 Tokens 降序排序</p>
                <div className="flex items-center gap-2">
          ...
          <SegmentContent value="group">
            <div className="flex items-center justify-between mb-3">
              <p className="text-xs text-[var(--text-weak)]">汇总所选时间范围内各分组的消耗，按总 Tokens 降序排序</p>
              <div className="flex items-center gap-2">
                <TokenGroupFilter
                  groups={groupTree}
                  value={groupFilter}
