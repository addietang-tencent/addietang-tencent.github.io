/**
 * StandardOpenClawMonitor - 标准模式·OpenClaw 列表页（留白占位）
 */
import { Construction } from "lucide-react";

export default function StandardOpenClawMonitor() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center">
      ...
      <div>
        <h2 className="text-lg font-semibold text-gray-800">标准模式 · OpenClaw 列表</h2>
